...
export default function PracticaDiptongos({ userEmail, globalSpeed, setGlobalSpeed, menuClics }) {
  ...
  // Rangos numéricos explícitos para los mapas de botones declarados con corchetes
  ...
  // --- FILTRADO DINÁMICO REAL DE DICTONGOS SEGÚN TU DATASET DE PRÁCTICA 2 ---
  ...
  const handleNextQuestion = async (e) => {
    ...
    if (currentQuestionIndex < 4) {
      ...
      try {
        ...
        console.log("✈️ Datos de diptongos transmitidos a Supabase.");
      } catch (err) {
