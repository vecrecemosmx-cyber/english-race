            ...
            <div className="w-full grid grid-cols-2 gap-3 pb-2 items-center">
              ...
              <div className="w-full">
                <button
                  ...
                  className="audio-btn hover:opacity-85 !font-black text-#1E293B tracking-tight flex items-center justify-center gap-1 !py-2.5 !px-2 !w-full h-10 rounded-xl transition-all duration-200"
