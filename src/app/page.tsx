...
export default function Home() {
  ...
  // Inicialización de tema Claro / Oscuro con persistencia local
  useEffect(() => {
  ...
  return (
    <main className={`min-h-screen transition-colors duration-300 pb-16 ${
      ...
      {/* Cabecera con botón selector de tema Día / Noche */}
      <header className={`border-b backdrop-blur-md sticky top-0 z-50 transition-colors ${
        ...
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Botón Selector Modo Día / Modo Noche */}
            <button
              onClick={toggleTheme}
        ...
        {!hasLearned ? (
          ...
          <div className="flex justify-center mb-8">
            <button
              ...
              className="flex items-center gap-2.5 px-6 py-3 rounded-2xl bg-white dark:bg-slate-900 border-2 border-blue-200 dark:border-blue-900/60 hover:border-amber-400 dark:hover:border-amber-400 text-blue-700 dark:text-sky-300 font-bold text-sm shadow-sm hover:shadow-md transition-all active:scale-95"
            >
